...
envsubst '$IMAGE_TAG $TELEGRAM_BOT_TOKEN $TELEGRAM_GROUP_CHAT_ID $DATABASE_URL $OPENAI_API_KEY $ACCESS_PIN $TOOLS_BIGIN_CLIENT_ID $TOOLS_BIGIN_CLIENT_SECRET $TOOLS_BIGIN_REFRESH_TOKEN $TOOLS_GMAIL_CLIENT_ID $TOOLS_GMAIL_CLIENT_SECRET $TOOLS_GMAIL_REFRESH_TOKEN $TOOLS_BRAVE_TOKEN' \
